#import "iDUGradientHeaderCell.h"

@implementation iDUGradientHeaderCell
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier specifier:(PSSpecifier *)specifier {
    ...
    if (self) {
        ...
        _blurContentView = [[iDUGradientHeaderCellBlurContentView alloc] initWithFrame:self.bounds];
        ...
        if (_animated) {
            ...
            [_gradientLayer addAnimation:animationGroup forKey:@"iDUAnimation"];
        }
        ...
        _label.text = specifier.properties[@"label"] ? [specifier.properties[@"label"] stringByInterpolatingPackageInfoFromControl:[iDUPackageInfo control]] : [iDUPackageInfo control][@"Name"];
        ...
        _detailLabel.text = specifier.properties[@"subtitle"] ? [specifier.properties[@"subtitle"] stringByInterpolatingPackageInfoFromControl:[iDUPackageInfo control]] : [@"v" stringByAppendingString:[iDUPackageInfo control][@"Version"]];
